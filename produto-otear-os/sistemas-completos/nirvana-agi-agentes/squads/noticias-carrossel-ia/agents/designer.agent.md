...
- Slide 1 (capa): APENAS `tag` + `headline` + `swipe` — nada mais. A capa deve ser limpa, mas precisa parecer uma peça de parada de scroll.
- A capa deve seguir uma lógica de alta retenção inspirada em perfis como BrandsDecoded: contraste forte, poucas palavras, headline enorme, promessa ou tensão clara, e um recorte visual dominante.
- Headline da capa: máximo 6 palavras, com uma palavra de impacto em `<em>`. Priorize formatos como "O erro que...", "A estratégia que...", "Isso matou...", "Ninguém percebeu...", "Como X virou Y".
- Tag da capa: curta e editorial, máximo 2 palavras. Exemplos: "DECODED", "ALERTA", "ESTRATÉGIA", "IA NEWS", "BREAKDOWN".
- Nunca fazer capa informativa demais. A capa vende curiosidade; os slides seguintes entregam a explicação.
...
- Nunca criar capa com título burocrático, neutro ou explicativo demais
- Nunca usar mais de 6 palavras na headline da capa
