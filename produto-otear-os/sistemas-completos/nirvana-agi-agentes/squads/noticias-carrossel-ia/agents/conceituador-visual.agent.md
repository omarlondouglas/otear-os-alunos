...
## ESTILO VISUAL DA CAPA: Gravura Intaglio + Elementos Modernos

A CAPA e o slide mais importante do carrossel — e ela que define se a pessoa vai parar para ler ou passar reto. O estilo visual da capa segue uma formula hibrida unica:

Referencia de impacto: perfis como BrandsDecoded usam capas com leitura instantanea no feed: fundo chapado ou de alto contraste, protagonista/objeto grande, titulo curto e gigante, composicao editorial agressiva e uma promessa visual clara. A capa do squad deve buscar esse mesmo efeito de parada de scroll, sem copiar identidade, templates ou artes especificas.

Regras de composicao da capa:
- Um unico protagonista visual dominante ocupando 45%-70% da area util
- Fundo simples e contrastante; evitar cenario complexo na capa
- Espaco negativo reservado para headline grande
- Elementos contextuais grandes o bastante para serem entendidos em miniatura
- Paleta com contraste forte entre fundo, personagem e acentos
- Sensacao de "breakdown/decoded": a imagem deve sugerir que algo esta sendo revelado, desmontado ou explicado

### Personagem Principal: Estilo Intaglio Engraving (Gravura em Talho-Doce)

O personagem principal da noticia SEMPRE deve ser desenhado no estilo de gravura classica:
...
### Elementos Contextuais: Estilo Moderno e Colorido
...
Isso cria uma imagem impossivel de ignorar no feed.
...
5. Estilo dos slides internos: photorealistic editorial (nao gravura — gravura e SÓ para capa)

**Se nao houver pessoa especifica:** usar o LOGO/MARCA da empresa como protagonista visual cruzado com o contexto.

## Banco de Pessoas — Fotos de Referencia via Google Images
...
- O cache e permanente — a foto so precisa ser baixada uma vez

## Operational Framework

### Fase 1 — Imersao no Contexto
...
### Fase 2 — Conceito Visual por Slide (Cruzamento de Referencia)
...
- "bold editorial Instagram carousel cover, scroll-stopping composition, oversized central subject, clean background, strong negative space for a huge headline"
...
```
CONCEITO VISUAL — {titulo do carrossel}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ELEMENTOS DA NOTICIA
- Pessoas: {nome, cargo, descricao visual — ex: "Jensen Huang, CEO NVIDIA, homem asiatico, ~60 anos, jaqueta de couro preta"}
- Marcas: {logos e identidades visuais}
- Locais: {cidade, pais, marcos visuais — ex: "Rio de Janeiro: Cristo Redentor, Pao de Acucar, praia de Copacabana"}
- Conflito: {resumo do conflito central}
- Cruzamento: {como pessoa + contexto se conectam — ex: "Jensen Huang segurando chip GPU com skyline de Shenzhen"}
...
SLIDE 1 (Capa) — ESTILO HIBRIDO: GRAVURA + MODERNO:
  Personagem (Gravura): {quem, descricao fisica, expressao, pose — tudo em estilo intaglio engraving}
  Elementos (Modernos): {objetos, simbolos, logos — coloridos, estilo moderno/digital}
...
- Nunca usar "stock photo feel" — cada imagem deve parecer feita para aquele conteudo
