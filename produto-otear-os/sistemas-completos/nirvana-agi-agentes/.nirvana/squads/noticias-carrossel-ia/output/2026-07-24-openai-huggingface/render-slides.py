...
if __name__ == "__main__":
    ...
    print("\n--- Screenshots ---")
    ok = 0
    for slide_id, html_path in htmls:
        png = os.path.join(OUTPUT_DIR, f"slide-{slide_id:02d}.png")
        if screenshot(html_path, png):
            print(f"png : slide-{slide_id:02d}.png")
            ok += 1
        else:
            print(f"FAIL: slide-{slide_id:02d}.png")
