...
import { getLocaleCode, loadLocale, t } from './i18n.js';
...
async function writeProjectReadme(targetDir) {
  ...
  await writeFile(join(targetDir, 'README.md'), localizeReadme(content), 'utf-8');
}

function localizeReadme(content) {
...
Abra esta pasta no seu IDE e digite \`/opensquad\` para começar.
...
Abre esta carpeta en tu IDE y escribe \`/opensquad\` para comenzar.
