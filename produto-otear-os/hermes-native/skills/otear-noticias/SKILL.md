---
name: otear-noticias
description: Converte notícia verificável em pauta ou carrossel com fontes e distinção entre fato e análise.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
6. Salve em `produto-otear-os/entregas/noticias/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
