...
6. Salve em `produto-otear-os/entregas/pesquisa-noticias/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
