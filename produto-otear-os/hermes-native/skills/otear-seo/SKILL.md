---
name: otear-seo
description: Planeja auditoria e conteúdo SEO com prioridades claras e verificáveis.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
- `produto-otear-os/agentes-base/auditor-seo.agent.md`
...
6. Salve em `produto-otear-os/entregas/seo/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
