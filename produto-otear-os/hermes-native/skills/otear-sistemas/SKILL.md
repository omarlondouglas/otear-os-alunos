---
name: otear-sistemas
description: Estrutura apps, automações e produtos digitais em escopo implementável.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
metadata:
  hermes:
    tags: [Otear, sistemas, apps, automacao]
    related_skills: [otear-router, otear-squad-orchestrator]
...
6. Salve em `produto-otear-os/entregas/sistemas/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
