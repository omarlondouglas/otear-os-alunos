---
name: otear-marca
description: Estrutura posicionamento, identidade verbal e direção de marca para o aluno.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
metadata:
  hermes:
    tags: [Otear, marca, posicionamento]
...
- `produto-otear-os/squads-base/squad-marca.yaml`
...
6. Salve em `produto-otear-os/entregas/marca/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
