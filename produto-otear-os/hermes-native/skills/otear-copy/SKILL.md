---
name: otear-copy
description: Cria e revisa copy persuasiva com briefing, prova e revisão no padrão Otear.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
metadata:
  hermes:
    tags: [Otear, copy, anuncios, email]
...
6. Salve em `produto-otear-os/entregas/copy/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
