---
name: otear-thumbnails
description: Cria direção de thumbnail com foco em mensagem, legibilidade e teste de variações.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
- `produto-otear-os/squads-base/squad-thumbnail-youtube.yaml`
...
6. Salve em `produto-otear-os/entregas/thumbnails/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
