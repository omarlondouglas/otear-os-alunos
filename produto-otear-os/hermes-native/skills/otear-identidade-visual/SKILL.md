---
name: otear-identidade-visual
description: Desenvolve direção de identidade visual consistente sem reutilizar material de clientes.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
metadata:
  hermes:
    tags: [Otear, identidade-visual, design]
    related_skills: [otear-marca, otear-router]
tools: [read_file, write_file, search_files]
---

# Otear Identidade Visual
...
- `produto-otear-os/squads-base/squad-identidade-visual.yaml`
...
6. Salve em `produto-otear-os/entregas/identidade-visual/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
