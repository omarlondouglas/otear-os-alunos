---
name: otear-sites
description: Planeja e produz artefatos de sites e landing pages portateis para o aluno.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
6. Salve em `produto-otear-os/entregas/sites/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
