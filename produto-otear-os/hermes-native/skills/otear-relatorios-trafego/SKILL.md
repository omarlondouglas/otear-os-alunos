---
name: otear-relatorios-trafego
description: Organiza relatórios de performance de mídia com dados, contexto e recomendações honestas.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
metadata:
  hermes:
    tags: [Otear, relatorios, trafego, performance]
    related_skills: [otear-trafego, otear-router]
tools: [read_file, write_file, search_files]
---

# Otear Relatórios de Tráfego
...
- `produto-otear-os/skills-base/relatório-de-trafego.skill.md`
...
6. Salve em `produto-otear-os/entregas/relatórios-trafego/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
