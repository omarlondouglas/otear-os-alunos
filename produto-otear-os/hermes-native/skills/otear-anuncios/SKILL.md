---
name: otear-anuncios
description: Produz briefings e peças de anúncio estático com revisão de mensagem e formato.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
metadata:
  hermes:
    tags: [Otear, anuncios, criativos]
    related_skills: [otear-copy, otear-router]
...
- `produto-otear-os/squads-base/squad-anuncio-estatico.yaml`
...
6. Salve em `produto-otear-os/entregas/anuncios/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
