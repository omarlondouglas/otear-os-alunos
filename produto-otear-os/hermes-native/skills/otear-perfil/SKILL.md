...
- `produto-otear-os/squads-base/squad-análise-de-perfil.yaml`
...
6. Salve em `produto-otear-os/entregas/perfil/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
