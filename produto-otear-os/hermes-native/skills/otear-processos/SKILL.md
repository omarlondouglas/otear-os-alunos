---
name: otear-processos
description: Mapeia e melhora processos com métricas, responsáveis e rotina operacional.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
- `produto-otear-os/squads-base/squad-melhoria-de-processos.yaml`
...
6. Salve em `produto-otear-os/entregas/processos/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
