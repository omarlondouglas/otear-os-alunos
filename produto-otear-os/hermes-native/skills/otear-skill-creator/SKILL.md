...
- `produto-otear-os/minhas-skills/README.md`
...
6. Salve em `produto-otear-os/minhas-skills/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
