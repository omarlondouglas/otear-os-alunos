---
name: otear-pesquisa
description: Planeja pesquisa profunda, curadoria e síntese com evidências verificáveis.
version: 0.1.0
author: Otear OS
license: UNLICENSED
...
- `produto-otear-os/squads-base/squad-conteúdo-longo.yaml`
...
6. Salve em `produto-otear-os/entregas/pesquisa/` quando houver escrita autorizada. Reabra o arquivo para conferir conteúdo, caminhos relativos e ausência de dados sensíveis.
