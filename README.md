...
title: Otear OS
created: 2026-08-22
tags: [otear-os, inicio, agentes, skills, squads]
---
...
- [[produto-otear-os/squads-base/squad-site|Squad Site Completo]]
- [[produto-otear-os/squads-base/squad-campanha-completa|Squad Campanha Completa]]
- [[produto-otear-os/squads-base/squad-copy-otear|Squad Copy Otear]]
- [[produto-otear-os/squads-base/squad-criador-de-agentes|Squad Criador de Agentes]]
- [[02-COMO-USAR/Modo Leigo|Modo Leigo]]
...
```text
Otear OS, crie uma campanha completa para meu produto.
```

```text
Otear OS, use o Squad Site Completo para montar uma landing page.
```
...
```text
Otear OS, transforme esse processo repetitivo em uma skill.
```
